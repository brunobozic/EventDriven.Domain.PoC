...
namespace EventDriven.Domain.PoC.Repository.EF.Migrations
{
    ...
    [Migration("20210712083804_changes-due-to-refactoring-3")]
    partial class changesduetorefactoring3
    {
            ...
            modelBuilder.Entity("EventDriven.Domain.PoC.Domain.DomainEntities.UserAggregate.AccountJournal.AccountJournalEntry", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 7, 12, 8, 38, 3, 834, DateTimeKind.Unspecified).AddTicks(414), new TimeSpan(0, 0, 0, 0, 0)));
