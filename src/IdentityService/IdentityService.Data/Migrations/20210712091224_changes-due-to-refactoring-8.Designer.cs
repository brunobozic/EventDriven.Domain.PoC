...
namespace EventDriven.Domain.PoC.Repository.EF.Migrations
{
    ...
    [Migration("20210712091224_changes-due-to-refactoring-8")]
    partial class changesduetorefactoring8
    {
            ...
            modelBuilder.Entity("EventDriven.Domain.PoC.Domain.DomainEntities.UserAggregate.AccountJournal.AccountJournalEntry", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 7, 12, 9, 12, 24, 88, DateTimeKind.Unspecified).AddTicks(630), new TimeSpan(0, 0, 0, 0, 0)));
