...
namespace EventDriven.Domain.PoC.SharedKernel.HealthChecks.Base
{
    /// <summary>
    ...
    public class HealthCheckItemResult
    {
        ...
        /// </summary>
        [JsonProperty(Order =
            -60)] // Push them to the top of the list, with the base properties coming first. https://stackoverflow.com/questions/32571695/order-of-fields-when-serializing-the-derived-class-in-json-net
