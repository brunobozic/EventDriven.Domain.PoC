...
namespace EventDriven.Domain.PoC.SharedKernel.Helpers.Configuration
{
    ...
    {
        /// <summary>
        ///     4.1.1.  "iss" (MachineIssuer) Claim - The "iss" (issuer) claim identifies the principal that issued the JWT.
        /// </summary>
        ...
        /// </summary>
        public int ValidFor { get; set; } = 10080;

        private TimeSpan ValidForTimeSpan => TimeSpan.FromMinutes(ValidFor);
