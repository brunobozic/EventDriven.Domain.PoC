			...
			get
			{
				...
				return new UserAgent
				{
					...
					Os = new Os
					{
						...
						Version =
 VersionString.Format(clientInfo.OS.Major, clientInfo.OS.Minor, clientInfo.OS.Patch, clientInfo.OS.PatchMinor),
					},
		...
		public Client Client
		{
			get
			{
				...
				var ip4 =
 _httpContextAccessor.HttpContext.Features.Get<IHttpConnectionFeature>()?.RemoteIpAddress.MapToIPv4();
