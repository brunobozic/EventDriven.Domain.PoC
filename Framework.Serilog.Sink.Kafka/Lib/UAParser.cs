...
namespace UAParser
{
    ...
    ///     ua-parser-output WebIDL structure defined in this document:
    ...
    internal sealed class Parser
    {
        ...
        private Parser(MinimalYamlParser yamlParser, ParserOptions options)
        {
            ...
            _userAgentParser =
                CreateParser(Read(yamlParser.ReadMapping("user_agent_parsers"), config.UserAgentSelector),
        ...
        {
            return new(new MinimalYamlParser(yaml), parserOptions);
        }

        /// <summary>
        ///     Returns a <see cref="Parser" /> instance based on the embedded regex definitions.
        ///     <remarks>
        ///         The embedded regex definitions may be outdated. Consider passing in external yaml definitions using
        ///         <see cref="Parser.FromYaml" />
        ///     </remarks>
        /// </summary>
        /// <param name="parserOptions">specifies the options for the parser</param>
        /// <returns></returns>
        ...
        /// </summary>
        internal OS ParseOS(string uaString)
        {
        ...
        /// </summary>
        internal Device ParseDevice(string uaString)
        {
        ...
        /// </summary>
        internal UserAgent ParseUserAgent(string uaString)
        {
        ...
        private static Func<string, TResult> CreateParser<T, TResult>(IEnumerable<Func<string, T>> parsers,
            T defaultValue, Func<T, TResult> selector) where T : class
        {
        ...
        private class Config
        {
            ...
            private Regex Regex(Func<string, string> indexer, string key, string regexFlag = null)
            {
                ...
                if ("i".Equals(regexFlag)) options |= RegexOptions.IgnoreCase;
        ...
        private static class Parsers
        {
            ...
            // ReSharper disable once InconsistentNaming
            internal static Func<string, OS> OS(Regex regex, string osReplacement, string v1Replacement,
                string v2Replacement, string v3Replacement, string v4Replacement)
            {
