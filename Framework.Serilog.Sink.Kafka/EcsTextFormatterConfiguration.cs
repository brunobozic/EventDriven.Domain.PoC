...
namespace Elastic.CommonSchema.Serilog
{
 ...
 = new HttpAdapter(v));
        ...
        public EcsTextFormatterConfiguration MapExceptions(bool value)
        {
            return Assign(this, value, (o, v) => o.MapExceptions = v);
        }

        public EcsTextFormatterConfiguration MapCurrentThread(bool value)
        {
            return Assign(this, value, (o, v) => o.MapCurrentThread = v);
        }

        public EcsTextFormatterConfiguration MapCustom(Func<Base, LogEvent, Base> value)
        {
            return Assign(this, value, (o, v) => o.MapCustom = v);
        }

        public EcsTextFormatterConfiguration LogEventPropertiesToFilter(ISet<string> value)
        {
            return Assign(this, value, (o, v) => o.LogEventPropertiesToFilter = v);
        }
