...
namespace EventDriven.Domain.PoC.Repository.EF.Migrations
{
    ...
    [Migration("20210712084916_changes-due-to-refactoring-5")]
    partial class changesduetorefactoring5
    {
            ...
            modelBuilder.Entity("EventDriven.Domain.PoC.Domain.DomainEntities.UserAggregate.AccountJournal.AccountJournalEntry", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 7, 12, 8, 49, 16, 25, DateTimeKind.Unspecified).AddTicks(8985), new TimeSpan(0, 0, 0, 0, 0)));
