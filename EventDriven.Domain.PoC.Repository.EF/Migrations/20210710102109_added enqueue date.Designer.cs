...
namespace EventDriven.Domain.PoC.Repository.EF.Migrations
{
    ...
    [Migration("20210710102109_added enqueue date")]
    partial class addedenqueuedate
    {
            ...
            modelBuilder.Entity("EventDriven.Domain.PoC.Domain.DomainEntities.UserAggregate.AccountJournal.AccountJournalEntry", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 7, 10, 10, 21, 8, 698, DateTimeKind.Unspecified).AddTicks(1712), new TimeSpan(0, 0, 0, 0, 0)));
