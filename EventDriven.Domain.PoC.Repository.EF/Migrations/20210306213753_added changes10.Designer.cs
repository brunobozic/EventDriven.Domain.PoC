...
namespace EventDriven.Domain.PoC.Repository.EF.Migrations
{
    ...
    [Migration("20210306213753_added changes10")]
    partial class addedchanges10
    {
            ...
            modelBuilder.Entity("EventDriven.Domain.PoC.Domain.Domain.AccountJournalEntry", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 6, 21, 37, 52, 569, DateTimeKind.Unspecified).AddTicks(376), new TimeSpan(0, 0, 0, 0, 0)));

                    b.Property<DateTimeOffset?>("DateDeleted")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 3, 6, 21, 37, 52, 577, DateTimeKind.Unspecified).AddTicks(2440), new TimeSpan(0, 0, 0, 0, 0)));
