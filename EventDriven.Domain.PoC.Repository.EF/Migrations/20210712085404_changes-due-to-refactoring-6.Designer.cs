...
namespace EventDriven.Domain.PoC.Repository.EF.Migrations
{
    ...
    [Migration("20210712085404_changes-due-to-refactoring-6")]
    partial class changesduetorefactoring6
    {
            ...
            modelBuilder.Entity("EventDriven.Domain.PoC.Domain.DomainEntities.UserAggregate.AccountJournal.AccountJournalEntry", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 7, 12, 8, 54, 4, 368, DateTimeKind.Unspecified).AddTicks(1244), new TimeSpan(0, 0, 0, 0, 0)));
